...
import phone from '../../../Multimedia/llamada.png';
import email from '../../../Multimedia/email.png';
                ...
                <div className='contenedorContactoForm'>
                    <div className='contenedorPhone'>
                        <div className='contenedorContactoPhone'>
                            <a href='https://www.linkedin.com/company/who-consultora-integral/mycompany/' target='_blank'>
                                <FontAwesomeIcon icon={faLinkedin} className='FontAwesomeIcon'/>       
                            </a>
                        </div>
                        <div className='contenedorContactoPhone'>
                            <a href='https://www.facebook.com/profile.php?id=100063522880814' target='_blank'>
                                <FontAwesomeIcon icon={faFacebook} className='FontAwesomeIcon'/>       
                            </a>
                        </div>
                        <div className='contenedorContactoPhone'>
                            <a href='https://www.instagram.com/whoconsultoraintegral/' target='_blank'>
